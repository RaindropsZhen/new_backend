...
urlpatterns = [
    ...
    path(
        "api/places/<int:place_id>/categories/reorder/",
        views.ReorderCategoriesView.as_view(),
        name="reorder-categories",
    ),
    path("api/categories/", views.CategoryList.as_view()),
    path("api/categories/<pk>", views.CategoryDetail.as_view()),
    path(
        "api/categories/<int:category_id>/menu-items/reorder/",
        views.ReorderMenuItemsView.as_view(),
